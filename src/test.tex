...
%!Equation
\begin{align*}
    f(x) =  & -5.694 \times 10^{-19} x^{9} + 4.099 \times 10^{-23} x^{8} - 1.24 \times 10^{-11} x^{7} \\
            & + 2.807 \times 10^{-8} x^{6} - 4.205 \times 10^{-5} x^{5} + 0.04166 x^{4} \\
            & - 26.31 x^{3} + 9614 x^{2} - 1.548 \times 10^{6}
\end{align*}


Based on these coefficients, the trendline equation would be:

\[f(x) = -1.548 \times 10^6 + 9614 x - 26.313 x^2 + 0.04166 x^3 - 4.204 \times 10^{-5} x^4 + 2.807 \times 10^{-8} x^5 - 1.239 \times 10^{-11} x^6 + 3.490 \times 10^{-15} x^7 - 5.694 \times 10^{-19} x^8 + 4.099 \times 10^{-23} x^9\]

This is a 9th-degree polynomial equation.
