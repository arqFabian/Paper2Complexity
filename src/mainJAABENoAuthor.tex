...
\affiliation[inst3]{organization={------------------------------------------------------------------------------------------------------------------------------------------------------------------------------__},%Department and Organization
            addressline={--------},
            city={---------------},
           postcode={------------},
           state={---------------},
...
\begin{keyword}
    Facade Design\sep Architectural Complexity\sep Virtual Reality\sep Computer Vision\sep Architectural Aesthetics
\end{keyword}
