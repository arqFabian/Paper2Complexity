...
\begin{minipage}{\textwidth}
    ...
    \captionof{figure}{CICA Flowchart illustrating the CICA system (element 2) (detailed in Section~\ref{subsubsec:CICAsystem}) in the Complexity Analysis System development (detailed in Section~\ref{subsec:ComplexitySystemDevelopment}).}
...
\begin{tabularx}
{\textwidth}{>{\centering\arraybackslash}X >{\centering\arraybackslash}X >{\centering\arraybackslash}X >{\centering\arraybackslash}X }
\toprule
...
\includegraphics[width=.8\linewidth]{Images/CICA3DRender1} &
\includegraphics[width=.8\linewidth]{Images/CICA3DRender2} &
\includegraphics[width=.8\linewidth]{Images/CICA3DRender3} &
\includegraphics[width=.8\linewidth]{Images/CICA3DRender4} \\
\midrule
\text{(b) Historical Analysis} &  &  & \\
\includegraphics[width=.8\linewidth]{Images/CICAHistory1} &
\includegraphics[width=.8\linewidth]{Images/CICAHistory2} &
\includegraphics[width=.8\linewidth]{Images/CICAHistory3} &
\includegraphics[width=.8\linewidth]{Images/CICAHistory4} \\
\bottomrule
\end{tabularx}
\end{minipage}
