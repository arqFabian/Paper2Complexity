...
%!Table Historical CICA scatter graph
...
\end{tabular}
\end{table*}
%!Table of Top and bottom scores for buildings
\begin{table*}[htb]
\centering
\small
\begin{tabular}{c}
    ...
    %Figure CICA bottom 5 buildings
    \begin{minipage}{\textwidth}
        \centering
