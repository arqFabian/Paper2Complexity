...
While the architectural world of the 20th and 21st centuries lacked a unified movement, certain architects emerged as torchbearers of distinct styles, each showcasing a unique interpretation of ornamentation and facades (Figure\ref{fig:contemporarytimeline}).
...
The late 20th century to the present day has witnessed a fascinating era of architectural exploration, giving rise to several prominent styles that have left an indelible mark on the field.
These styles include Deconstructivism, Neofuturism, High-tech modernism, Parametricism, and Pragmatic utopianism, each offering a unique perspective on architecture and design.

In the realm of Deconstructivism, which gained prominence in the 1980s\cite{Clement2017}, architects like Frank Gehry pioneered a distinct interpretation of ornamentation (see Figure\ref{fig:contemporarytimeline} \textit{a}).



In the realm of Deconstructivism, particularly prominent in the 1980's\cite{Clement2017}, as exemplified by the innovative architect Frank Gehry, the interpretation of ornament takes on a highly unconventional and dynamic character.

 In this style, ornamentation takes on an unconventional and dynamic character.
