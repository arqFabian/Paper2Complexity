...
The ornamentation became a language through which buildings could communicate their cultural relevance, while also responding to the demands of a rapidly changing world (Figure\ref{fig:contemporarytimeline}).

%% Figure of Postmodernism facade and ornament
     \begin{figure*}[htb]
          \centering
          \includegraphics[width= \linewidth]{Images/contemporaryTimeline}
          \caption{progress of contemporary architects and unique interpretations of facades and ornamentation. (From Left to Right)High tech modernism, descontructivism and parametricism styles. (Left)  (Right) \textit{(Images edited from source)}}
