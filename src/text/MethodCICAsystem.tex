...
The outputs of these metrics are normalized and combined into a `Unified Complexity Score' using the `Complexity Score' function \(f_1(x)\), defined in Equation~\ref{eq:F1_ComplexityScoreFunction1} as follows:
...
This function is a key component of the CICA system, enabling a thorough assessment of architectural complexity.
