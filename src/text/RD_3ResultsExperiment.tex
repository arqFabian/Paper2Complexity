...
While these results primarily demonstrate the CICA system's capability to quantify facade complexity, its application also holds promise for sustainable design.
