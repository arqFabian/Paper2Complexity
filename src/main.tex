    ...
    \begin{table*}[htb]
        ...
        \begin{tabular}{c}
            ...
            \begin{minipage}{\textwidth}
                ...
                \captionof{figure}{VR simulation of interior (right) and exterior (middle) of existing laboratory building as seen during the VR experiment for Facade complexity Analysis when going through the different facade variation across all three patterns. Detail of VR interface (left). Predetermined cameras(1), Slider with variations of facades by level of complexity(2), Render preview of building with facade design (3), Comparison scatter graph with individual complexity scores of facade variations (4), Save and reset buttons (5) also used to transition among the three patterns.}
